...
def set_font():
    ...
    if 'freemono' in pygame.font.get_fonts():
        ...
        # Apple
        font = pygame.font.SysFont("monica", font_size)
    else:
        # Windows
...
def main_loop():
    ...
    _lvl_player("qwer", all_words[2], increment=3)
    _lvl_player("uiop", all_words[3], increment=4)
    _lvl_player("qweruiop", all_words[4], increment=5)
