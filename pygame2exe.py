...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "module_1.py"
 
        #Name of program
        self.project_name = "YTT"
        ...
        #Auhor of program
        self.author_name = "Raymond Chung"
        self.author_email = "rchung725@gmail.com"
        self.copyright = "Copyright (c) 2016 Raymond Chung."
        ...
        self.extra_datas = ['location.dat', 'word-list.dat']
